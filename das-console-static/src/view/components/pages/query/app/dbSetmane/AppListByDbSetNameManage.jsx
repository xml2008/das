...
import {AppListByDbSetNameControl} from '../../../../../../controller/Index'
import QueryBaseManageCloudPanle from '../../base/QueryBaseManageCloudPanle'
import CommonHeader from '../../../base/common/CommonHeader'
import AppListByDbSetNameHeader from './AppListByDbSetNameHeader'
import {DataList} from '../../../../utils/Index'
import {View} from 'ea-react-dm-v14'

@View(AppListByDbSetNameControl)
export default class AppListByDbSetNameManage extends QueryBaseManageCloudPanle {
    ...
    render() {
        ...
        return <CommonHeader {..._props} message='数据查询' loadList={::this.loadList}>
                <AppListByDbSetNameHeader {..._props} loadList={::this.loadList}>
                    <DataList {..._props}
                              doubleShow={true}
                              loadData={::this.loadData}/>
                </AppListByDbSetNameHeader>
            </CommonHeader>
    }
}
