...
import {DataBaseQueryDbSetControl} from '../../../../../../controller/Index'
import QueryBaseManageCloudPanle from '../../base/QueryBaseManageCloudPanle'
import CommonHeader from '../../../base/common/CommonHeader'
import DatabasePageListDbSetHeader from './DatabasePageListDbSetHeader'
import {DataList} from '../../../../utils/Index'
import {View} from 'ea-react-dm-v14'

@View(DataBaseQueryDbSetControl)
export default class DatabasePageListDbSetManage extends QueryBaseManageCloudPanle {
    ...
    render() {
        ...
        return <CommonHeader {..._props} message='数据查询' loadList={::this.loadList}>
                <DatabasePageListDbSetHeader {..._props} loadList={::this.loadList}>
                    <DataList {..._props}
                              doubleShow={true}
                              loadData={::this.loadData}/>
                </DatabasePageListDbSetHeader>
            </CommonHeader>
    }
}
