...
export default class DatabasePageListAppidsHeader extends QueryBaseManageCloudPanle {
        ...
        return <div style={{padding: '10px 0px 0px 0px'}}>
            <Row style={{padding: '0px 0px 10px 0px'}}>
                <Col sm={20} style={{fontSize: '17px', fontWeight: 'bolder'}}>
                    <Itemlabel title='APPIDS : ' type={2} formLayout={this.topicNames} style={{marginBottom: '0px'}}>
                        <InputAntPlus {..._props} valueLink={this.searchInfoData} placeholder='请输入appid，多个用逗号隔开，中英文逗号皆可'
