...
public class DasBatchUpdateBuilder implements org.apache.thrift.TBase<DasBatchUpdateBuilder, DasBatchUpdateBuilder._Fields>, java.io.Serializable, Cloneable, Comparable<DasBatchUpdateBuilder> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> statements; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> valuesList; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String hints; // optional
  ...
  public DasBatchUpdateBuilder(DasBatchUpdateBuilder other) {
    ...
    if (other.isSetValuesList()) {
      java.util.List<java.lang.String> __this__valuesList = new java.util.ArrayList<java.lang.String>(other.valuesList);
  ...
  public DasBatchUpdateBuilder setStatements(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> statements) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getValuesListIterator() {
    return (this.valuesList == null) ? null : this.valuesList.iterator();
  }

  public void addToValuesList(java.lang.String elem) {
    if (this.valuesList == null) {
      this.valuesList = new java.util.ArrayList<java.lang.String>();
    }
  ...
  public DasBatchUpdateBuilder setValuesList(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> valuesList) {
  ...
  public DasBatchUpdateBuilder setHints(@org.apache.thrift.annotation.Nullable java.lang.String hints) {
    this.hints = hints;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case VALUES_LIST:
      if (value == null) {
        ...
        setValuesList((java.util.List<java.lang.String>)value);
      }
      break;
    ...
    case HINTS:
      if (value == null) {
        ...
        setHints((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(DasBatchUpdateBuilder other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStatements()).compareTo(other.isSetStatements());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DasBatchUpdateBuilder(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.statements = new java.util.ArrayList<java.lang.String>(_list94.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.valuesList = new java.util.ArrayList<java.lang.String>(_list97.size);
      ...
      if (struct.statements != null) {
        if (struct.isSetStatements()) {
          oprot.writeFieldBegin(STATEMENTS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter100 : struct.statements)
            {
      ...
      if (struct.valuesList != null) {
        if (struct.isSetValuesList()) {
          oprot.writeFieldBegin(VALUES_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter101 : struct.valuesList)
            {
      ...
      if (struct.isSetStatements()) {
        {
          ...
          for (java.lang.String _iter102 : struct.statements)
          {
      ...
      if (struct.isSetValuesList()) {
        {
          ...
          for (java.lang.String _iter103 : struct.valuesList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.statements = new java.util.ArrayList<java.lang.String>(_list104.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.valuesList = new java.util.ArrayList<java.lang.String>(_list107.size);
