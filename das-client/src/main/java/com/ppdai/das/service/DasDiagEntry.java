...
public class DasDiagEntry implements org.apache.thrift.TBase<DasDiagEntry, DasDiagEntry._Fields>, java.io.Serializable, Cloneable, Comparable<DasDiagEntry> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> contexts; // optional
  ...
  public DasDiagEntry(DasDiagEntry other) {
    ...
    if (other.isSetContexts()) {
      java.util.Map<java.lang.String,java.lang.String> __this__contexts = new java.util.HashMap<java.lang.String,java.lang.String>(other.contexts);
  ...
  public DasDiagEntry setStage(@org.apache.thrift.annotation.Nullable java.lang.String stage) {
    this.stage = stage;
    return this;
  }
  ...
  public void putToContexts(java.lang.String key, java.lang.String val) {
    if (this.contexts == null) {
      this.contexts = new java.util.HashMap<java.lang.String,java.lang.String>();
    }
    this.contexts.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.lang.String> getContexts() {
    return this.contexts;
  }

  public DasDiagEntry setContexts(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> contexts) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CONTEXTS:
      if (value == null) {
        ...
        setContexts((java.util.Map<java.lang.String,java.lang.String>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DasDiagEntry(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contexts = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map166.size);
      ...
      if (struct.contexts != null) {
        if (struct.isSetContexts()) {
          oprot.writeFieldBegin(CONTEXTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter170 : struct.contexts.entrySet())
            {
      ...
      if (struct.isSetContexts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter171 : struct.contexts.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.contexts = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map172.size);
