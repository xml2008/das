...
public class TxCommitCommandRequest implements org.apache.thrift.TBase<TxCommitCommandRequest, TxCommitCommandRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TxCommitCommandRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TxCommitCommandRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TxCommitCommandRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TxCommitCommandRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TxCommitCommandRequest.class, metaDataMap);
  }

  public TxCommitCommandRequest() {
  }
   ...
   */
  public TxCommitCommandRequest(TxCommitCommandRequest other) {
    if (other.isSetXid()) {
  ...
  public TxCommitCommandRequest deepCopy() {
    return new TxCommitCommandRequest(this);
  }
  ...
  public TxCommitCommandRequest setXid(@org.apache.thrift.annotation.Nullable TxXID xid) {
    this.xid = xid;
    return this;
  }
  ...
  public TxCommitCommandRequest setTxName(@org.apache.thrift.annotation.Nullable java.lang.String txName) {
    this.txName = txName;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TxCommitCommandRequest)
      return this.equals((TxCommitCommandRequest)that);
    return false;
  }

  public boolean equals(TxCommitCommandRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TxCommitCommandRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TxCommitCommandRequest(");
    boolean first = true;
  ...
  private static class TxCommitCommandRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TxCommitCommandRequestStandardScheme getScheme() {
      return new TxCommitCommandRequestStandardScheme();
    }
  }

  private static class TxCommitCommandRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TxCommitCommandRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TxCommitCommandRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TxCommitCommandRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TxCommitCommandRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TxCommitCommandRequestTupleScheme getScheme() {
      return new TxCommitCommandRequestTupleScheme();
    }
  }

  private static class TxCommitCommandRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TxCommitCommandRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TxCommitCommandRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TxCommitCommandRequest struct) throws org.apache.thrift.TException {
