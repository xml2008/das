...
public class DasHints implements org.apache.thrift.TBase<DasHints, DasHints._Fields>, java.io.Serializable, Cloneable, Comparable<DasHints> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<DasHintEnum,java.lang.String> hints; // required
  ...
  public DasHints(
    java.util.Map<DasHintEnum,java.lang.String> hints)
  {
    this();
    this.hints = hints;
  }
  ...
  public DasHints(DasHints other) {
    if (other.isSetHints()) {
      java.util.Map<DasHintEnum,java.lang.String> __this__hints = new java.util.EnumMap<DasHintEnum,java.lang.String>(DasHintEnum.class);
      for (java.util.Map.Entry<DasHintEnum, java.lang.String> other_element : other.hints.entrySet()) {
        ...
        java.lang.String __this__hints_copy_value = other_element_value;
  ...
  public void putToHints(DasHintEnum key, java.lang.String val) {
    if (this.hints == null) {
      this.hints = new java.util.EnumMap<DasHintEnum,java.lang.String>(DasHintEnum.class);
    }
    this.hints.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<DasHintEnum,java.lang.String> getHints() {
    return this.hints;
  }

  public DasHints setHints(@org.apache.thrift.annotation.Nullable java.util.Map<DasHintEnum,java.lang.String> hints) {
    this.hints = hints;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case HINTS:
      if (value == null) {
        ...
        setHints((java.util.Map<DasHintEnum,java.lang.String>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DasHints(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.hints = new java.util.EnumMap<DasHintEnum,java.lang.String>(DasHintEnum.class);
                ...
                {
                  _key77 = com.ppdai.das.service.DasHintEnum.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DasHints struct) throws org.apache.thrift.TException {
      ...
      if (struct.hints != null) {
        oprot.writeFieldBegin(HINTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<DasHintEnum, java.lang.String> _iter80 : struct.hints.entrySet())
          {
  ...
  private static class DasHintsTupleScheme extends org.apache.thrift.scheme.TupleScheme<DasHints> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, DasHints struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<DasHintEnum, java.lang.String> _iter81 : struct.hints.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, DasHints struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        {
          _key83 = com.ppdai.das.service.DasHintEnum.findByValue(iprot.readI32());
