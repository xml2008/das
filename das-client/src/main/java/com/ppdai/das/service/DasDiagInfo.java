...
public class DasDiagInfo implements org.apache.thrift.TBase<DasDiagInfo, DasDiagInfo._Fields>, java.io.Serializable, Cloneable, Comparable<DasDiagInfo> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> diagnoseInfoMap; // required
  ...
  public DasDiagInfo(
    ...
    java.util.Map<java.lang.String,java.lang.String> diagnoseInfoMap)
  {
    this();
    this.name = name;
  ...
  public DasDiagInfo(DasDiagInfo other) {
    ...
    if (other.isSetDiagnoseInfoMap()) {
      java.util.Map<java.lang.String,java.lang.String> __this__diagnoseInfoMap = new java.util.HashMap<java.lang.String,java.lang.String>(other.diagnoseInfoMap);
  ...
  public DasDiagInfo setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public void putToDiagnoseInfoMap(java.lang.String key, java.lang.String val) {
    if (this.diagnoseInfoMap == null) {
      this.diagnoseInfoMap = new java.util.HashMap<java.lang.String,java.lang.String>();
    }
    this.diagnoseInfoMap.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.lang.String> getDiagnoseInfoMap() {
    return this.diagnoseInfoMap;
  }

  public DasDiagInfo setDiagnoseInfoMap(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> diagnoseInfoMap) {
    this.diagnoseInfoMap = diagnoseInfoMap;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SPACE_LEVEL:
      if (value == null) {
        ...
        setSpaceLevel((java.lang.Integer)value);
      }
      break;
    ...
    case DIAGNOSE_INFO_MAP:
      if (value == null) {
        ...
        setDiagnoseInfoMap((java.util.Map<java.lang.String,java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(DasDiagInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpaceLevel()).compareTo(other.isSetSpaceLevel());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpaceLevel()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDiagnoseInfoMap()).compareTo(other.isSetDiagnoseInfoMap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDiagnoseInfoMap()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DasDiagInfo(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.diagnoseInfoMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map179.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DasDiagInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.diagnoseInfoMap != null) {
        oprot.writeFieldBegin(DIAGNOSE_INFO_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter184 : struct.diagnoseInfoMap.entrySet())
          {
      ...
      if (struct.isSetDiagnoseInfoMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter186 : struct.diagnoseInfoMap.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.diagnoseInfoMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map190.size);
