...
public class DasResult implements org.apache.thrift.TBase<DasResult, DasResult._Fields>, java.io.Serializable, Cloneable, Comparable<DasResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> batchRowsIndex; // optional
  ...
  public DasResult(DasResult other) {
    ...
    if (other.isSetBatchRowsIndex()) {
      java.util.List<java.lang.Integer> __this__batchRowsIndex = new java.util.ArrayList<java.lang.Integer>(other.batchRowsIndex);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Integer> getBatchRowsIndexIterator() {
  ...
  public void addToBatchRowsIndex(int elem) {
    if (this.batchRowsIndex == null) {
      this.batchRowsIndex = new java.util.ArrayList<java.lang.Integer>();
    }
    this.batchRowsIndex.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Integer> getBatchRowsIndex() {
    return this.batchRowsIndex;
  }

  public DasResult setBatchRowsIndex(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> batchRowsIndex) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BATCH_ROWS_INDEX:
      if (value == null) {
        ...
        setBatchRowsIndex((java.util.List<java.lang.Integer>)value);
      }
      break;
  ...
  public int compareTo(DasResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBatchRowsIndex()).compareTo(other.isSetBatchRowsIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBatchRowsIndex()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDiagInfo()).compareTo(other.isSetDiagInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDiagInfo()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DasResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchRowsIndex = new java.util.ArrayList<java.lang.Integer>(_list215.size);
                int _elem216;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.batchRowsIndex = new java.util.ArrayList<java.lang.Integer>(_list225.size);
          int _elem226;
