...
public class LoginUserCloudDao extends BaseDao {
    ...
    public List<LoginUserView> getUserByGroupId(Long groupId) throws SQLException {
        ...
        return this.queryBySql(sql, LoginUserView.class, Parameter.integerOf(StringUtils.EMPTY, groupId));
    }
