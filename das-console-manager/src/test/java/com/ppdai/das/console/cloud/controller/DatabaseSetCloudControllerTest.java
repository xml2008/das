...
@WebMvcTest(DatabaseSetCloudController.class)
public class DatabaseSetCloudControllerTest {
    ...
    public void getdbSetListByGroupId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/das/dbset/getdbSetListByGroupId")
    ...
    @Test
    public void getdbSetListByProjectId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/das/dbset/getdbSetListByProjectId")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .param("project_id", "1")
                .accept(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(MockMvcResultMatchers.status().isOk())
